                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <!-- <li class="active">
                                    <a href="form-elements-component.html">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Input Data Pesanan</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li> -->
                                <!-- <li>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-block">
                                                            <form method="POST" action="{{route('insertpesan')}}">
                                                                {{csrf_field()}}
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">Jenis Cake</label>
                                                                        <div class="col-sm-10">
                                                                            <select class="form-control" name="jenis_cake">
                                                                                <option value="opt1">Pilih Jenis Cake</option>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">Jumlah Cake</label>
                                                                        <div class="col-sm-10">
                                                                        <input type="number"  name="jumlah_cake" class="form-control"
                                                                        placeholder="Jumlah cake">
                                                                    </div>
                                                            </div>
                                                                    <div class="form-group row">
