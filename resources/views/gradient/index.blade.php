...
<head>
    <title>Sistem Informasi Penjualan Kue Berbasis Web pada Toko Chris Cake</title>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <!-- <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Input Data Pesanan</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a> -->
                            ...
                            <!-- <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li>
                                    <a href="bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Pusat</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Cabang Limbangan</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <!-- <li>
                                    <a href="chart.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Laporan Data Pesanan</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li> -->
                                <!-- <li>
                            ...
                            <div class="main-body">
                                ...
                                <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-body">
                                                <a href="/tambah-pesan" class="btn btn-sm btn-danger">Tambah</a>
                                            </div>
                                            @endif
                                            <div class="card-header-right">
												<ul class="list-unsetyled card-option">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('dashboard/'.$r->id_pesanan) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-blue order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Stock Kue yang Ada</h6>
                                                        <h3 class="text-right"><i class="ti-shopping-cart f-left"></i><span>238</span></h3>
                                                        <p class="m-b-0">Kue yang Terjual<span class="f-right">112</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-green order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Total yang Terjual Bulan ini</h6>
                                                        <h3 class="text-right"><i class="ti-tag f-left"></i><span>389</span></h3>
                                                        <p class="m-b-0">Hari ini<span class="f-right">104</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-yellow order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Pendapatan Bulan ini</h6>
                                                        <h3 class="text-right"><i class="ti-reload f-left"></i><span>Rp.4.890.500</span></h3>
                                                        <p class="m-b-0">Hari ini<span class="f-right">Rp.920.000</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-pink order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Total Keuntungan Bulan ini</h6>
                                                        <h3 class="text-right"><i class="ti-wallet f-left"></i><span>Rp.2.985.000</span></h3>
                                                        <p class="m-b-0">Hari ini<span class="f-right">Rp.345.000</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- order-card end -->
